...
const images = [
  ...
  const updateImageDimensions = async (images) => {
  ...
  const main = async () => {
    const updatedImages = await updateImageDimensions(images);
    ...
    console.log(`Updated image dimensions saved to ${outputFilePath}`);
  };
